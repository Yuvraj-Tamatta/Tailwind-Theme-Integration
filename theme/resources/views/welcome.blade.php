...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/tabler-icons/3.24.0/tabler-icons.min.css" integrity="sha512-DPG2HbXmHL0nwJ6erX5ppS2ot0LvCvsVEUDLaBa429nLcb6R+XZ2O4fqXyMG/pGIwJK8GjzKIxfCHLropPNaiw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
            ...
            >
              <ul class="py-1" aria-labelledby="navNotifications">
                <li class="py-2 px-4">
                  <a href="javascript:void(0);" class="dropdown-item">
                    <div class="flex align-items-start">
                        <img class="object-cover rounded-full h-8 w-8 shrink-0 mr-3" src="{{ asset('assets/images/users/avatar-2.jpg') }}" alt="logo" />
                ...
                <li class="py-2 px-4">
                  <a href="javascript:void(0);" class="dropdown-item">
                    <div class="flex align-items-start">
                        <img class="object-cover rounded-full h-8 w-8 shrink-0 mr-3" src="{{ asset('assets/images/users/avatar-3.jpg') }}" alt="logo" />
                        <div class="flex-grow ml-0.5 overflow-hidden">
                ...
                <li class="py-2 px-4">
                  <a href="javascript:void(0);" class="dropdown-item">
                    <div class="flex align-items-start">
                        <img class="object-cover rounded-full h-8 w-8 shrink-0 mr-3" src="{{ asset('assets/images/users/avatar-9.jpg') }}" alt="logo" />
                        <div class="flex-grow ml-0.5 overflow-hidden">
                ...
                <li class="py-2 px-4">
                  <a href="javascript:void(0);" class="dropdown-item">
                    <div class="flex align-items-start">
                        <img class="object-cover rounded-full h-8 w-8 shrink-0 mr-3" src="{{ asset('assets/images/users/avatar-6.jpg') }}" alt="logo" />
                        <div class="flex-grow ml-0.5 overflow-hidden">
